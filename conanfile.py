...
class FollyConan(ConanFile):
    ...
    def build(self):
        ...
        tools.replace_in_file(os.path.join(self._source_subfolder, "CMakeLists.txt"), "target_link_libraries(folly PUBLIC folly_deps)", "target_link_libraries(folly PUBLIC folly_deps atomic)")
